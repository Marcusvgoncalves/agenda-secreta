...
// Só aplica o rate limit se NÃO estivermos no ambiente de teste
if (process.env.NODE_ENV !== 'test') {
    console.log('Aplicando Rate Limiter para o ambiente de produção/desenvolvimento.');
    app.use('/auth', loginLimiter, authRoutes);
} else {
    app.use('/auth', authRoutes); // No ambiente de teste, usa as rotas sem o limiter
}
